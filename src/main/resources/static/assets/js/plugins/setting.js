...
(function () {
    ...
    const updateMode = () => {
        ...
        if(allActiveType !== null && allActiveType !== undefined && document.querySelector('.sidebar')) {
        ...
        if(allNavbarType !== null && allNavbarType !== undefined && document.querySelector('.iq-navbar')){
